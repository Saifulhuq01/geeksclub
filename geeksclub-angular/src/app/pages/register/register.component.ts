...
export class RegisterComponent {
    ...
    this.authService.register(registerData).subscribe({
      ...
      error: (error) => {
        ...
        if (error.status === 400) {
          ...
          this.errorMessage.set('Email or username already exists. Please try another.');
  ...
  protected getPasswordMismatchError(): string | null {
    ...
    if (confirmPassword && confirmPassword.touched && this.registerForm.errors && this.registerForm.errors['passwordMismatch']) {
